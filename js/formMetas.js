            ...
            <div class="tab-pane fade show active" id="meta${i+1}" aria-labelledby="meta${i+1}-tab">
              <div class="row m-0 pt-1">
                ...
                <div class="form-group col-2">
                  <label for="peso">Peso (%) <span class="required-field">*</span></label>
                  <select name="peso" id="peso" class="form-control select-peso" required></select>
                </div>
                <div class="form-group col-6">
                  <label for="prior-estrat">Prioridade Estratégica <span class="required-field">*</span></label>
                  <select name="prior-estrat" id="prior-estrat" class="form-control select-priorestrat" required></select>
                </div>
                <div class="form-group col-2">
                  <label for="prazo">Prazo <span class="required-field">*</span></label>
                  <select name="prazo" id="prazo" class="form-control select-prazo" required></select>
                </div>
          ...
          <div class="tab-pane fade show active" id="meta${i+1}" aria-labelledby="meta${i+1}-tab">
            ...
            <div class="row m-0 pt-1">
              ...
              <div class="form-group col-2">
                ...
                <select name="peso" id="peso" class="form-control select-peso" ></select>
              </div>
              <div class="form-group col-6">
                <label for="prior-estrat">Prioridade Estratégica</label>
                <select name="prior-estrat" id="prior-estrat" class="form-control select-priorestrat" ></select>
              </div>
              <div class="form-group col-2">
                <label for="prazo">Prazo</label>
                <select name="prazo" id="prazo" class="form-control select-prazo" ></select>
              </div>
